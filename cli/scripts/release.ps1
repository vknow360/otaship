...
$LDFlags = "-s -w -X github.com/vknow360/otaship/cli/internal/commands.Version=$Version -X github.com/vknow360/otaship/cli/internal/commands.BuildDate=$BuildDate"
