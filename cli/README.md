...
**Pre-built binaries:**
Binaries for Windows (`otaship-cli.exe`), Linux (`otaship-cli`), and macOS (`otaship-cli_mac`) are automatically generated by GitHub Actions. You can download them directly from the [Releases](https://github.com/vknow360/otaship/releases) page.
